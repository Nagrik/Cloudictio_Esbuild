...
const server = http.createServer(async (request, response) => {
    ...
    return handler(request, response, { public: "./www", rewrites: [{ source: "**", destination: "index.html" }] },
        {
            createReadStream(filePath, config) {
                ...
                const r = Readable.from(Buffer.from(fileContent))
